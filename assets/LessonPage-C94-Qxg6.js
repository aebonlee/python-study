import{r as h,u as L,j as n,c as R,l as q,L as w,b as X}from"./index-DU1JOTgP.js";import{u as B}from"./useCodeRunner-PdyxAnLs.js";const U={"hello-python":{sections:[{title:"print() 함수로 출력하기",content:`파이썬에서 가장 먼저 배우는 것은 화면에 텍스트를 출력하는 것입니다.
...
Epoch 10/10 - Loss: 0.1484 - Accuracy: 98.71%`,tip:"TensorFlow는 프로덕션 배포에, PyTorch는 연구/프로토타이핑에 많이 사용됩니다. 최근에는 두 프레임워크 모두 기능이 비슷해지고 있습니다."}]}},k="__TURTLE_SVG__";function W({initialCode:u="",expectedOutput:l="",lessonId:T=""}){const[a,o]=h.useState(u),[j,x]=h.useState(!1),[f,r]=h.useState([]),[N,m]=h.useState(!1),g=h.useRef(null),{incrementCodeRuns:_}=L(),{status:c,output:e,errorMsg:s,runCode:p,resetOutput:A}=B(),S=c==="loading"||c==="running",b=h.useMemo(()=>{const t=[],i=a.split(`
`);let d=0;for(const y of i){const O=[...y.matchAll(/(?:text)?(?:num)?input\s*\(\s*(?:["']([^"']*)["']|([^)]*))\s*\)/g)];for(const z of O){const I=z[1]||z[2]||`입력 ${d+1}`;t.push({index:d,prompt:I.trim()||`입력 ${d+1}`,line:y.trim()}),d++}}return t},[a]),M=h.useMemo(()=>/import\s+turtle|from\s+turtle\s+import|turtle\.Turtle/.test(a),[a]),P=e&&e.includes(k),v=P?e.substring(0,e.indexOf(k)).trim():e,C=P?e.substring(e.indexOf(k)+k.length).trim():"",D=async()=>{if(b.length>0&&!N){m(!0),r(t=>{const i=[...t];for(;i.length<b.length;)i.push("");return i});return}m(!1),await p(a,f),_()},F=async()=>{m(!1),await p(a,f),_()},J=()=>{o(u),r([]),m(!1),A()},E=t=>{if(t.key==="Tab"){t.preventDefault();const i=t.target.selectionStart,d=t.target.selectionEnd,y=a.substring(0,i)+"    "+a.substring(d);o(y),setTimeout(()=>{t.target.selectionStart=t.target.selectionEnd=i+4},0)}(t.ctrlKey||t.metaKey)&&t.key==="Enter"&&D()},K=a.split(`
`).length,H=c==="done"||c==="error"||e||s;return n.jsxs("div",{className:"code-editor",children:[n.jsxs("div",{className:"editor-toolbar",children:[n.jsxs("div",{className:"editor-title",children:[n.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[n.jsx("polyline",{points:"16 18 22 12 16 6"}),n.jsx("polyline",{points:"8 6 2 12 8 18"})]}),n.jsx("span",{children:"Python Editor"}),c==="loading"&&n.jsx("span",{className:"editor-badge",children:"Python 로딩 중..."}),b.length>0&&n.jsx("span",{className:"editor-badge",children:"input()"}),M&&n.jsx("span",{className:"editor-badge turtle-badge",children:"Turtle"})]}),n.jsxs("div",{className:"editor-actions",children:[n.jsx("button",{className:"editor-btn hint-btn",onClick:()=>x(!j),title:"힌트",children:n.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[n.jsx("circle",{cx:"12",cy:"12",r:"10"}),n.jsx("path",{d:"M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"}),n.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]})}),n.jsx("button",{className:"editor-btn reset-btn",onClick:J,title:"초기화",children:n.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[n.jsx("polyline",{points:"1 4 1 10 7 10"}),n.jsx("path",{d:"M3.51 15a9 9 0 102.13-9.36L1 10"})]})}),n.jsxs("button",{className:"editor-btn run-btn",onClick:D,disabled:S,title:"실행 (Ctrl+Enter)",children:[S?n.jsx("div",{className:"loading-spinner-small"}):n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})}),n.jsx("span",{children:S?"실행 중...":"실행"})]})]})]}),n.jsxs("div",{className:"editor-body",children:[n.jsx("div",{className:"line-numbers",children:Array.from({length:K},(t,i)=>n.jsx("span",{children:i+1},i+1))}),n.jsx("textarea",{ref:g,className:"code-input",value:a,onChange:t=>o(t.target.value),onKeyDown:E,spellCheck:!1,placeholder:"# 파이썬 코드를 입력하세요..."})]}),N&&b.length>0&&n.jsxs("div",{className:"editor-input-panel",children:[n.jsxs("div",{className:"input-panel-header",children:[n.jsx("i",{className:"fa-solid fa-keyboard"}),n.jsx("span",{children:"입력값을 입력하세요"})]}),n.jsx("div",{className:"input-panel-body",children:b.map((t,i)=>n.jsxs("div",{className:"input-field",children:[n.jsx("label",{children:t.prompt}),n.jsx("input",{type:"text",value:f[i]||"",onChange:d=>r(y=>{const O=[...y];return O[i]=d.target.value,O}),onKeyDown:d=>{d.key==="Enter"&&F()},placeholder:"값을 입력하세요...",autoFocus:i===0})]},i))}),n.jsxs("div",{className:"input-panel-actions",children:[n.jsx("button",{className:"editor-btn",onClick:()=>m(!1),children:"취소"}),n.jsxs("button",{className:"editor-btn run-btn",onClick:F,children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})}),n.jsx("span",{children:"실행"})]})]})]}),j&&l&&n.jsxs("div",{className:"editor-hint",children:[n.jsx("strong",{children:"예상 출력:"})," ",n.jsx("code",{children:l})]}),H&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"output-header",children:[n.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[n.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),n.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),n.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}),n.jsx("span",{children:"출력 결과"}),l&&v&&v.trim()===l.trim()&&n.jsx("span",{className:"output-correct",children:"정답!"})]}),n.jsxs("div",{className:`editor-output-content${c==="error"?" has-error":""}`,children:[v&&n.jsx("pre",{className:"output-content",children:v}),C&&n.jsx("div",{className:"editor-turtle-svg",dangerouslySetInnerHTML:{__html:C}}),s&&n.jsx("pre",{className:"output-content editor-error",children:s}),!e&&!s&&c==="done"&&n.jsx("span",{className:"editor-no-output",children:"(출력 없음)"})]})]})]})}function G(){const{level:u,lessonId:l}=R(),{completedLessons:T,completeLesson:a}=L(),[o,j]=h.useState(0),x=X[u],f=q[u]||[],r=f.find(s=>s.id===l),N=U[l],m=T.has(l),g=f.findIndex(s=>s.id===l),_=g>0?f[g-1]:null,c=g<f.length-1?f[g+1]:null;if(!r||!x)return n.jsx("div",{className:"not-found-page",children:n.jsxs("div",{className:"not-found-content",children:[n.jsx("div",{className:"not-found-code",children:"404"}),n.jsx("h2",{className:"not-found-title",children:"레슨을 찾을 수 없습니다"}),n.jsx(w,{to:`/${u}`,className:"btn btn-primary",children:"목록으로 돌아가기"})]})});const e=N?.sections||[{title:r.title,content:`이 레슨에서는 ${r.description}에 대해 학습합니다.`,code:`# 예제 코드
print("Hello, Python!")`,expectedOutput:"Hello, Python!"}];return n.jsxs("div",{className:"lesson-page",children:[n.jsx("section",{className:"page-header",style:{background:`linear-gradient(135deg, ${x.color}, ${x.color}dd)`},children:n.jsxs("div",{className:"container",children:[n.jsxs("div",{className:"breadcrumb",children:[n.jsx(w,{to:"/",children:"홈"}),n.jsx("span",{children:"/"}),n.jsxs(w,{to:`/${u}`,children:[x.title," 과정"]}),n.jsx("span",{children:"/"}),n.jsx("span",{children:r.title})]}),n.jsxs("div",{className:"page-header-content",children:[n.jsx("span",{className:"page-header-icon",children:n.jsx("i",{className:r.icon})}),n.jsx("h1",{children:r.title}),n.jsx("p",{children:r.description}),n.jsxs("div",{className:"lesson-meta-bar",children:[n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clock"})," 약 ",r.estimatedTime,"분"]}),n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clipboard"})," ",r.topics?.length||0,"개 주제"]}),n.jsx("span",{children:Array.from({length:3},(s,p)=>n.jsx("i",{className:p<r.difficulty?"fa-solid fa-star":"fa-regular fa-star"},p))})]})]})]})}),n.jsxs("div",{className:"lesson-layout container",children:[n.jsxs("aside",{className:"lesson-sidebar",children:[n.jsx("h3",{children:"학습 목차"}),n.jsx("ul",{className:"lesson-toc",children:e.map((s,p)=>n.jsx("li",{children:n.jsxs("button",{className:`toc-item${o===p?" active":""}`,onClick:()=>j(p),children:[n.jsx("span",{className:"toc-number",children:p+1}),n.jsx("span",{className:"toc-title",children:s.title})]})},p))}),r.topics&&n.jsxs("div",{className:"lesson-topics-list",children:[n.jsx("h4",{children:"학습 주제"}),r.topics.map((s,p)=>n.jsx("span",{className:"topic-tag",children:s},p))]})]}),n.jsxs("main",{className:"lesson-content",children:[n.jsxs("div",{className:"lesson-section",children:[n.jsx("h2",{children:e[o]?.title}),n.jsx("div",{className:"lesson-text",dangerouslySetInnerHTML:{__html:e[o]?.content?.replace(/\n/g,"<br/>")}}),e[o]?.code&&n.jsxs("div",{className:"lesson-practice",children:[n.jsx("h3",{children:"직접 실습해보세요"}),n.jsx(W,{initialCode:e[o].code,expectedOutput:e[o].expectedOutput||"",lessonId:l})]}),e[o]?.tip&&n.jsxs("div",{className:"lesson-tip",children:[n.jsx("span",{className:"tip-icon",children:n.jsx("i",{className:"fa-solid fa-lightbulb"})}),n.jsxs("div",{children:[n.jsx("strong",{children:"팁:"})," ",e[o].tip]})]})]}),n.jsxs("div",{className:"lesson-nav",children:[n.jsx("div",{className:"lesson-nav-left",children:_&&n.jsxs(w,{to:`/${u}/${_.id}`,className:"lesson-nav-btn prev",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"15 18 9 12 15 6"})}),n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"이전 레슨"}),n.jsx("span",{className:"nav-title",children:_.title})]})]})}),!m&&n.jsxs("button",{className:"btn btn-accent complete-btn",onClick:()=>a(l),children:[n.jsx("i",{className:"fa-solid fa-check"})," 학습 완료"]}),m&&n.jsxs("span",{className:"completed-badge-inline",children:[n.jsx("i",{className:"fa-solid fa-check"})," 완료됨"]}),n.jsx("div",{className:"lesson-nav-right",children:c&&n.jsxs(w,{to:`/${u}/${c.id}`,className:"lesson-nav-btn next",children:[n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"다음 레슨"}),n.jsx("span",{className:"nav-title",children:c.title})]}),n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"9 18 15 12 9 6"})})]})})]})]})]})]})}export{G as default};
