import{r as c,u as A,j as n,c as R,l as q,L as v,b as X}from"./index-WtO8DNTf.js";import{u as B}from"./useCodeRunner-DNwILoLi.js";const U={"hello-python":{sections:[{title:"print() 함수로 출력하기",content:`파이썬에서 가장 먼저 배우는 것은 화면에 텍스트를 출력하는 것입니다.
...
Epoch 10/10 - Loss: 0.1484 - Accuracy: 98.71%`,tip:"TensorFlow는 프로덕션 배포에, PyTorch는 연구/프로토타이핑에 많이 사용됩니다. 최근에는 두 프레임워크 모두 기능이 비슷해지고 있습니다."}]}},S="__TURTLE_SVG__";function V({initialCode:u="",expectedOutput:p="",lessonId:P=""}){const[i,l]=c.useState(u),[y,x]=c.useState(!1),[f,r]=c.useState([]),[O,m]=c.useState(!1),g=c.useRef(null),{incrementCodeRuns:h}=A(),{status:d,output:e,errorMsg:s,runCode:a,resetOutput:_}=B(),b=d==="loading"||d==="running",T=c.useMemo(()=>{const t=[];for(const o of i.split(`
`)){if(o.trim().startsWith("#"))continue;const w=[...o.matchAll(new RegExp(`(?<![a-zA-Z])input\\s*\\(\\s*(?:["']([^"']*?)["'])?\\s*\\)`,"g"))];for(const j of w)t.push(j[1]||"입력하세요:");const N=[...o.matchAll(/(?:textinput|numinput)\s*\(\s*["'][^"']*["']\s*,\s*["']([^"']*?)["']/g)];for(const j of N)t.push(j[1]||"입력하세요:")}return t},[i]),L=c.useMemo(()=>/import\s+turtle|from\s+turtle\s+import|turtle\.Turtle/.test(i),[i]),C=e&&e.includes(S),k=C?e.substring(0,e.indexOf(S)).trim():e,D=C?e.substring(e.indexOf(S)+S.length).trim():"",F=c.useCallback(()=>{m(!1);const t=T;if(t.length>0){_(),r(new Array(t.length).fill("")),m(!0);return}a(i),h()},[a,i,T,_,h]),M=c.useCallback(t=>{t.preventDefault(),m(!1),a(i,f),h()},[a,i,f,h]),J=c.useCallback(()=>{l(u),r([]),m(!1),_()},[u,_]),E=c.useCallback(()=>{_(),m(!1)},[_]),K=t=>{if(t.key==="Tab"){t.preventDefault();const o=t.target.selectionStart,w=t.target.selectionEnd,N=i.substring(0,o)+"    "+i.substring(w);l(N),setTimeout(()=>{t.target.selectionStart=t.target.selectionEnd=o+4},0)}(t.ctrlKey||t.metaKey)&&t.key==="Enter"&&F()},H=i.split(`
`).length,I=e||s;return n.jsxs("div",{className:"code-editor",children:[n.jsxs("div",{className:"editor-header",children:[n.jsxs("span",{className:"editor-header-title",children:[n.jsx("i",{className:"fa-brands fa-python"})," Python Editor",L&&n.jsx("span",{className:"editor-header-badge",children:"Turtle"})]}),n.jsx("div",{className:"editor-header-actions",children:p&&n.jsxs("button",{className:`editor-header-btn${y?" active":""}`,onClick:()=>x(!y),children:[n.jsx("i",{className:"fa-solid fa-lightbulb"})," 힌트"]})})]}),n.jsxs("div",{className:"editor-body",children:[n.jsx("div",{className:"line-numbers",children:Array.from({length:H},(t,o)=>n.jsx("span",{children:o+1},o+1))}),n.jsx("textarea",{ref:g,className:"code-input",value:i,onChange:t=>l(t.target.value),onKeyDown:K,spellCheck:!1,disabled:b,placeholder:"# 파이썬 코드를 입력하세요..."})]}),n.jsxs("div",{className:"editor-toolbar-bottom",children:[n.jsx("button",{className:"editor-btn run-btn",onClick:F,disabled:b,children:b?n.jsxs(n.Fragment,{children:[n.jsx("div",{className:"loading-spinner-small"})," ",d==="loading"?"Python 로딩 중...":"실행 중..."]}):n.jsxs(n.Fragment,{children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})}),n.jsxs("div",{className:"editor-toolbar-right",children:[n.jsx("button",{className:"editor-btn",onClick:J,disabled:b,children:"초기화"}),I&&n.jsx("button",{className:"editor-btn",onClick:E,disabled:b,children:"출력 지우기"})]})]}),y&&p&&n.jsxs("div",{className:"editor-hint",children:[n.jsx("strong",{children:"예상 출력:"})," ",n.jsx("code",{children:p})]}),O&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:[n.jsx("i",{className:"fa-solid fa-keyboard"})," 입력값 입력"]}),n.jsxs("form",{className:"editor-input-form",onSubmit:M,children:[T.map((t,o)=>n.jsxs("div",{className:"editor-input-row",children:[n.jsx("label",{children:t}),n.jsx("input",{className:"editor-input-field",value:f[o]||"",onChange:w=>{const N=o;r(j=>{const z=[...j];return z[N]=w.target.value,z})},autoFocus:o===0})]},o)),n.jsxs("button",{type:"submit",className:"editor-btn run-btn",children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})]})]}),!O&&(d==="done"||d==="error"||e||s)&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:["실행 결과",p&&k&&k.trim()===p.trim()&&n.jsx("span",{className:"output-correct",children:"정답!"})]}),n.jsxs("div",{className:`editor-output-content${d==="error"?" has-error":""}`,children:[k&&n.jsx("pre",{className:"editor-stdout",children:k}),D&&n.jsx("div",{className:"editor-turtle-svg",dangerouslySetInnerHTML:{__html:D}}),s&&n.jsx("pre",{className:"editor-stderr",children:s}),!e&&!s&&d==="done"&&n.jsx("span",{className:"editor-no-output",children:"(출력 없음)"})]})]})]})}function W(){const{level:u,lessonId:p}=R(),{completedLessons:P,completeLesson:i}=A(),[l,y]=c.useState(0),x=X[u],f=q[u]||[],r=f.find(s=>s.id===p),O=U[p],m=P.has(p),g=f.findIndex(s=>s.id===p),h=g>0?f[g-1]:null,d=g<f.length-1?f[g+1]:null;if(!r||!x)return n.jsx("div",{className:"not-found-page",children:n.jsxs("div",{className:"not-found-content",children:[n.jsx("div",{className:"not-found-code",children:"404"}),n.jsx("h2",{className:"not-found-title",children:"레슨을 찾을 수 없습니다"}),n.jsx(v,{to:`/${u}`,className:"btn btn-primary",children:"목록으로 돌아가기"})]})});const e=O?.sections||[{title:r.title,content:`이 레슨에서는 ${r.description}에 대해 학습합니다.`,code:`# 예제 코드
print("Hello, Python!")`,expectedOutput:"Hello, Python!"}];return n.jsxs("div",{className:"lesson-page",children:[n.jsx("section",{className:"page-header",style:{background:`linear-gradient(135deg, ${x.color}, ${x.color}dd)`},children:n.jsxs("div",{className:"container",children:[n.jsxs("div",{className:"breadcrumb",children:[n.jsx(v,{to:"/",children:"홈"}),n.jsx("span",{children:"/"}),n.jsxs(v,{to:`/${u}`,children:[x.title," 과정"]}),n.jsx("span",{children:"/"}),n.jsx("span",{children:r.title})]}),n.jsxs("div",{className:"page-header-content",children:[n.jsx("span",{className:"page-header-icon",children:n.jsx("i",{className:r.icon})}),n.jsx("h1",{children:r.title}),n.jsx("p",{children:r.description}),n.jsxs("div",{className:"lesson-meta-bar",children:[n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clock"})," 약 ",r.estimatedTime,"분"]}),n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clipboard"})," ",r.topics?.length||0,"개 주제"]}),n.jsx("span",{children:Array.from({length:3},(s,a)=>n.jsx("i",{className:a<r.difficulty?"fa-solid fa-star":"fa-regular fa-star"},a))})]})]})]})}),n.jsxs("div",{className:"lesson-layout container",children:[n.jsxs("aside",{className:"lesson-sidebar",children:[n.jsx("h3",{children:"학습 목차"}),n.jsx("ul",{className:"lesson-toc",children:e.map((s,a)=>n.jsx("li",{children:n.jsxs("button",{className:`toc-item${l===a?" active":""}`,onClick:()=>y(a),children:[n.jsx("span",{className:"toc-number",children:a+1}),n.jsx("span",{className:"toc-title",children:s.title})]})},a))}),r.topics&&n.jsxs("div",{className:"lesson-topics-list",children:[n.jsx("h4",{children:"학습 주제"}),r.topics.map((s,a)=>n.jsx("span",{className:"topic-tag",children:s},a))]})]}),n.jsxs("main",{className:"lesson-content",children:[n.jsxs("div",{className:"lesson-section",children:[n.jsx("h2",{children:e[l]?.title}),n.jsx("div",{className:"lesson-text",dangerouslySetInnerHTML:{__html:e[l]?.content?.replace(/\n/g,"<br/>")}}),e[l]?.code&&n.jsxs("div",{className:"lesson-practice",children:[n.jsx("h3",{children:"직접 실습해보세요"}),n.jsx(V,{initialCode:e[l].code,expectedOutput:e[l].expectedOutput||"",lessonId:p})]}),e[l]?.tip&&n.jsxs("div",{className:"lesson-tip",children:[n.jsx("span",{className:"tip-icon",children:n.jsx("i",{className:"fa-solid fa-lightbulb"})}),n.jsxs("div",{children:[n.jsx("strong",{children:"팁:"})," ",e[l].tip]})]})]}),n.jsxs("div",{className:"lesson-nav",children:[n.jsx("div",{className:"lesson-nav-left",children:h&&n.jsxs(v,{to:`/${u}/${h.id}`,className:"lesson-nav-btn prev",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"15 18 9 12 15 6"})}),n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"이전 레슨"}),n.jsx("span",{className:"nav-title",children:h.title})]})]})}),!m&&n.jsxs("button",{className:"btn btn-accent complete-btn",onClick:()=>i(p),children:[n.jsx("i",{className:"fa-solid fa-check"})," 학습 완료"]}),m&&n.jsxs("span",{className:"completed-badge-inline",children:[n.jsx("i",{className:"fa-solid fa-check"})," 완료됨"]}),n.jsx("div",{className:"lesson-nav-right",children:d&&n.jsxs(v,{to:`/${u}/${d.id}`,className:"lesson-nav-btn next",children:[n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"다음 레슨"}),n.jsx("span",{className:"nav-title",children:d.title})]}),n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"9 18 15 12 9 6"})})]})})]})]})]})]})}export{W as default};
