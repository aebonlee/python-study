const t=[{name:"string1",title:"이름 입력 후 인사 출력",desc:"input()과 print() 기본 사용법",code:`# === 이름 입력 후 인사 출력 ===
...
print("파이썬에 오신 것을 환영합니다.")   # 환영 메시지 출력`},{name:"chat",title:"대화형 입력 프로그램",desc:"이름과 나이를 입력받아 인삿말 출력",code:`# === 대화형 입력 프로그램 ===
...
print("내년이면 " + str(age + 1) + "이 되시는군요.")  # 정수→문자열 변환 후 연결`},{name:"var",title:"변수 타입 변경",desc:"동적 타입 변경(정수→실수→문자열)",code:`# === 변수의 동적 타입 변경 ===
...
print("x =", x)`},{name:"type",title:"데이터 타입 확인",desc:"type() 함수로 자료형 확인",code:`# === 데이터 타입 확인 프로그램 ===
# type() 함수는 값의 자료형(데이터 타입)을 반환합니다.

print(type("Hello World!"))  # <class 'str'>  → 문자열 타입
print(type(3.2))             # <class 'float'> → 실수 타입
print(type(17))              # <class 'int'>   → 정수 타입`},{name:"sum",title:"두 변수의 합",desc:"변수에 값을 저장하고 합산",code:`# === 두 정수의 합 계산 ===
...
print(x + y)  # 두 정수의 합 출력`},{name:"sum1",title:"두 정수 합 (타입변환)",desc:"int()로 입력값 변환 후 합산",code:`# === 두 변수의 합 (직접 대입) ===
...
print(x, "과", y, "의 합은", sum, "입니다.")  # 결과 출력`},{name:"sum2",title:"두 정수 입력 후 합",desc:"input()과 int() 조합 예제",code:`# === 두 정수 입력 후 합산 ===
...
sum = x + y  # 합산
print(x, "과", y, "의 합은", sum, "입니다.")`},{name:"fstring",title:"f-string 형식 출력",desc:"상품 정보를 f-string으로 포맷팅",code:`# === f-string 형식 출력 ===
...
pi = 3.141592
print(f"원주율={pi:.2f}")  # :.2f → 소수점 둘째 자리까지 출력`},{name:"initial",title:"이름 이니셜 추출",desc:"문자열 인덱싱으로 이니셜 조합",code:`# === 이름 이니셜 추출 ===
...
print("\\n영어 이니셜은 " + initial + "입니다.")`},{name:"journal",title:"스포츠 기사 자동 작성",desc:"입력값을 조합해 야구 기사 출력",code:`# === 스포츠 기사 자동 작성 프로그램 ===
