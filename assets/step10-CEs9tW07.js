const e=[{name:"list",title:"리스트 기초",desc:"생성, append, 인덱싱, in 연산자",code:`# === 리스트 기초 ===
...
print(f"표준편차={statistics.stdev(sample):.4f}")  # 표본 표준편차`},{name:"hangman",title:"행맨 게임",desc:"리스트로 글자 맞히기 게임",code:`# === 행맨 게임 ===
...
if turns <= 0:
    print(f"\\n사용자 패배! 정답은 '{word}'")`}];export{e as default};
