import{r as c,u as L,d as M,j as n,c as X,l as B,L as O,b as U}from"./index-Vf8xh579.js";import{u as V}from"./useCodeRunner-BI7HfsTs.js";const $={"hello-python":{sections:[{title:"print() 함수로 출력하기",content:`파이썬에서 가장 먼저 배우는 것은 화면에 텍스트를 출력하는 것입니다.
...
Epoch 10/10 - Loss: 0.1484 - Accuracy: 98.71%`,tip:"TensorFlow는 프로덕션 배포에, PyTorch는 연구/프로토타이핑에 많이 사용됩니다. 최근에는 두 프레임워크 모두 기능이 비슷해지고 있습니다."}]}},S="__TURTLE_SVG__";function G({initialCode:f="",expectedOutput:i="",lessonId:C=""}){const[s,y]=c.useState(f),[x,d]=c.useState(!1),[b,g]=c.useState([]),[m,e]=c.useState(!1),T=c.useRef(null),{incrementCodeRuns:h}=L(),{requireAuth:_}=M(),{status:u,output:a,errorMsg:o,runCode:l,resetOutput:r}=V(),w=u==="loading"||u==="running",P=c.useMemo(()=>{const t=[];for(const p of s.split(`
`)){if(p.trim().startsWith("#"))continue;const N=[...p.matchAll(new RegExp(`(?<![a-zA-Z])input\\s*\\(\\s*(?:["']([^"']*?)["'])?\\s*\\)`,"g"))];for(const v of N)t.push(v[1]||"입력하세요:");const j=[...p.matchAll(/(?:textinput|numinput)\s*\(\s*["'][^"']*["']\s*,\s*["']([^"']*?)["']/g)];for(const v of j)t.push(v[1]||"입력하세요:")}return t},[s]),J=c.useMemo(()=>/import\s+turtle|from\s+turtle\s+import|turtle\.Turtle/.test(s),[s]),D=a&&a.includes(S),k=D?a.substring(0,a.indexOf(S)).trim():a,F=D?a.substring(a.indexOf(S)+S.length).trim():"",z=c.useCallback(()=>{e(!1);const t=P;if(t.length>0){r(),g(new Array(t.length).fill("")),e(!0);return}l(s),h()},[l,s,P,r,h]),E=c.useCallback(t=>{t.preventDefault(),e(!1),l(s,b),h()},[l,s,b,h]),K=c.useCallback(()=>{y(f),g([]),e(!1),r()},[f,r]),H=c.useCallback(()=>{r(),e(!1)},[r]),I=t=>{if(t.key==="Tab"){t.preventDefault();const p=t.target.selectionStart,N=t.target.selectionEnd,j=s.substring(0,p)+"    "+s.substring(N);y(j),setTimeout(()=>{t.target.selectionStart=t.target.selectionEnd=p+4},0)}(t.ctrlKey||t.metaKey)&&t.key==="Enter"&&z()},q=s.split(`
`).length,R=a||o;return n.jsxs("div",{className:"code-editor",children:[n.jsxs("div",{className:"editor-header",children:[n.jsxs("span",{className:"editor-header-title",children:[n.jsx("i",{className:"fa-brands fa-python"})," Python Editor",J&&n.jsx("span",{className:"editor-header-badge",children:"Turtle"})]}),n.jsx("div",{className:"editor-header-actions",children:i&&n.jsxs("button",{className:`editor-header-btn${x?" active":""}`,onClick:()=>d(!x),children:[n.jsx("i",{className:"fa-solid fa-lightbulb"})," 힌트"]})})]}),n.jsxs("div",{className:"editor-body",children:[n.jsx("div",{className:"line-numbers",children:Array.from({length:q},(t,p)=>n.jsx("span",{children:p+1},p+1))}),n.jsx("textarea",{ref:T,className:"code-input",value:s,onChange:t=>y(t.target.value),onKeyDown:I,spellCheck:!1,disabled:w,placeholder:"# 파이썬 코드를 입력하세요..."})]}),n.jsxs("div",{className:"editor-toolbar-bottom",children:[n.jsx("button",{className:"editor-btn run-btn",onClick:()=>_(z),disabled:w,children:w?n.jsxs(n.Fragment,{children:[n.jsx("div",{className:"loading-spinner-small"})," ",u==="loading"?"Python 로딩 중...":"실행 중..."]}):n.jsxs(n.Fragment,{children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})}),n.jsxs("div",{className:"editor-toolbar-right",children:[n.jsx("button",{className:"editor-btn",onClick:K,disabled:w,children:"초기화"}),R&&n.jsx("button",{className:"editor-btn",onClick:H,disabled:w,children:"출력 지우기"})]})]}),x&&i&&n.jsxs("div",{className:"editor-hint",children:[n.jsx("strong",{children:"예상 출력:"})," ",n.jsx("code",{children:i})]}),m&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:[n.jsx("i",{className:"fa-solid fa-keyboard"})," 입력값 입력"]}),n.jsxs("form",{className:"editor-input-form",onSubmit:E,children:[P.map((t,p)=>n.jsxs("div",{className:"editor-input-row",children:[n.jsx("label",{children:t}),n.jsx("input",{className:"editor-input-field",value:b[p]||"",onChange:N=>{const j=p;g(v=>{const A=[...v];return A[j]=N.target.value,A})},autoFocus:p===0})]},p)),n.jsxs("button",{type:"submit",className:"editor-btn run-btn",children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})]})]}),!m&&(u==="done"||u==="error"||a||o)&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:["실행 결과",i&&k&&k.trim()===i.trim()&&n.jsx("span",{className:"output-correct",children:"정답!"})]}),n.jsxs("div",{className:`editor-output-content${u==="error"?" has-error":""}`,children:[k&&n.jsx("pre",{className:"editor-stdout",children:k}),F&&n.jsx("div",{className:"editor-turtle-svg",dangerouslySetInnerHTML:{__html:F}}),o&&n.jsx("pre",{className:"editor-stderr",children:o}),!a&&!o&&u==="done"&&n.jsx("span",{className:"editor-no-output",children:"(출력 없음)"})]})]})]})}function Z(){const{level:f,lessonId:i}=X(),{completedLessons:C,completeLesson:s,uncompleteLesson:y}=L(),{requireAuth:x}=M(),[d,b]=c.useState(0),g=U[f],m=B[f]||[],e=m.find(l=>l.id===i),T=$[i],h=C.has(i),_=m.findIndex(l=>l.id===i),u=_>0?m[_-1]:null,a=_<m.length-1?m[_+1]:null;if(!e||!g)return n.jsx("div",{className:"not-found-page",children:n.jsxs("div",{className:"not-found-content",children:[n.jsx("div",{className:"not-found-code",children:"404"}),n.jsx("h2",{className:"not-found-title",children:"레슨을 찾을 수 없습니다"}),n.jsx(O,{to:`/${f}`,className:"btn btn-primary",children:"목록으로 돌아가기"})]})});const o=T?.sections||[{title:e.title,content:`이 레슨에서는 ${e.description}에 대해 학습합니다.`,code:`# 예제 코드
print("Hello, Python!")`,expectedOutput:"Hello, Python!"}];return n.jsxs("div",{className:"lesson-page",children:[n.jsx("section",{className:"page-header",children:n.jsxs("div",{className:"container",children:[n.jsxs("div",{className:"breadcrumb",children:[n.jsx(O,{to:"/",children:"홈"}),n.jsx("span",{children:"/"}),n.jsxs(O,{to:`/${f}`,children:[g.title," 과정"]}),n.jsx("span",{children:"/"}),n.jsx("span",{children:e.title})]}),n.jsx("div",{className:"page-header-content",children:n.jsxs("div",{className:"page-header-title-row",children:[n.jsx("span",{className:"page-header-icon",children:n.jsx("i",{className:e.icon})}),n.jsxs("div",{children:[n.jsx("h1",{children:e.title}),n.jsx("p",{children:e.description}),n.jsxs("div",{className:"lesson-meta-bar",children:[n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clock"})," 약 ",e.estimatedTime,"분"]}),n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clipboard"})," ",e.topics?.length||0,"개 주제"]}),n.jsx("span",{children:Array.from({length:3},(l,r)=>n.jsx("i",{className:r<e.difficulty?"fa-solid fa-star":"fa-regular fa-star"},r))})]})]})]})})]})}),n.jsxs("div",{className:"lesson-layout container",children:[n.jsxs("aside",{className:"lesson-sidebar",children:[n.jsx("h3",{children:"학습 목차"}),n.jsx("ul",{className:"lesson-toc",children:o.map((l,r)=>n.jsx("li",{children:n.jsxs("button",{className:`toc-item${d===r?" active":""}`,onClick:()=>b(r),children:[n.jsx("span",{className:"toc-number",children:r+1}),n.jsx("span",{className:"toc-title",children:l.title})]})},r))}),e.topics&&n.jsxs("div",{className:"lesson-topics-list",children:[n.jsx("h4",{children:"학습 주제"}),e.topics.map((l,r)=>n.jsx("span",{className:"topic-tag",children:l},r))]})]}),n.jsxs("main",{className:"lesson-content",children:[n.jsxs("div",{className:"lesson-section",children:[n.jsx("h2",{children:o[d]?.title}),n.jsx("div",{className:"lesson-text",dangerouslySetInnerHTML:{__html:o[d]?.content?.replace(/\n/g,"<br/>")}}),o[d]?.code&&n.jsxs("div",{className:"lesson-practice",children:[n.jsx("h3",{children:"직접 실습해보세요"}),n.jsx(G,{initialCode:o[d].code,expectedOutput:o[d].expectedOutput||"",lessonId:i},`${i}-${d}`)]}),o[d]?.tip&&n.jsxs("div",{className:"lesson-tip",children:[n.jsx("span",{className:"tip-icon",children:n.jsx("i",{className:"fa-solid fa-lightbulb"})}),n.jsxs("div",{children:[n.jsx("strong",{children:"팁:"})," ",o[d].tip]})]})]}),n.jsxs("div",{className:"lesson-nav",children:[n.jsx("div",{className:"lesson-nav-left",children:u&&n.jsxs(O,{to:`/${f}/${u.id}`,className:"lesson-nav-btn prev",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"15 18 9 12 15 6"})}),n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"이전 레슨"}),n.jsx("span",{className:"nav-title",children:u.title})]})]})}),!h&&n.jsxs("button",{className:"btn btn-accent complete-btn",onClick:()=>x(()=>s(i)),children:[n.jsx("i",{className:"fa-solid fa-check"})," 학습 완료"]}),h&&n.jsxs("button",{className:"btn btn-outline complete-toggle-btn",onClick:()=>x(()=>y(i)),children:[n.jsx("i",{className:"fa-solid fa-rotate-left"})," 완료 취소"]}),n.jsx("div",{className:"lesson-nav-right",children:a&&n.jsxs(O,{to:`/${f}/${a.id}`,className:"lesson-nav-btn next",children:[n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"다음 레슨"}),n.jsx("span",{className:"nav-title",children:a.title})]}),n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"9 18 15 12 9 6"})})]})})]})]})]})]})}export{Z as default};
