import{r as h,u as J,e as E,b as H,j as n,d as $,l as V,L as k,c as G}from"./index-RF0vwLhU.js";import{u as W}from"./useCodeRunner-BvZjBwh8.js";const Y={"hello-python":{sections:[{title:"print() 함수로 출력하기",content:`파이썬에서 가장 먼저 배우는 것은 화면에 텍스트를 출력하는 것입니다.
...
Epoch 10/10 - Loss: 0.1484 - Accuracy: 98.71%`,tip:"TensorFlow는 프로덕션 배포에, PyTorch는 연구/프로토타이핑에 많이 사용됩니다. 최근에는 두 프레임워크 모두 기능이 비슷해지고 있습니다."}]}},P="__TURTLE_SVG__";function Z({initialCode:x="",expectedOutput:a="",lessonId:F=""}){const[o,N]=h.useState(x),[w,_]=h.useState(!1),[d,u]=h.useState([]),[m,b]=h.useState(!1),S=h.useRef(null),{incrementCodeRuns:g}=J(),{requireAuth:r}=E(),{t:e,lang:C}=H(),{status:f,output:p,errorMsg:y,runCode:c,resetOutput:i}=W(),s=f==="loading"||f==="running",D=h.useMemo(()=>{const t=[];for(const l of o.split(`
`)){if(l.trim().startsWith("#"))continue;const j=[...l.matchAll(new RegExp(`(?<![a-zA-Z])input\\s*\\(\\s*(?:["']([^"']*?)["'])?\\s*\\)`,"g"))];for(const O of j)t.push(O[1]||e("editor.inputPlaceholder"));const v=[...l.matchAll(/(?:textinput|numinput)\s*\(\s*["'][^"']*["']\s*,\s*["']([^"']*?)["']/g)];for(const O of v)t.push(O[1]||e("editor.inputPlaceholder"))}return t},[o,e]),I=h.useMemo(()=>/import\s+turtle|from\s+turtle\s+import|turtle\.Turtle/.test(o),[o]),z=p&&p.includes(P),T=z?p.substring(0,p.indexOf(P)).trim():p,L=z?p.substring(p.indexOf(P)+P.length).trim():"",A=h.useCallback(()=>{b(!1);const t=D;if(t.length>0){i(),u(new Array(t.length).fill("")),b(!0);return}c(o),g()},[c,o,D,i,g]),K=h.useCallback(t=>{t.preventDefault(),b(!1),c(o,d),g()},[c,o,d,g]),q=h.useCallback(()=>{N(x),u([]),b(!1),i()},[x,i]),R=h.useCallback(()=>{i(),b(!1)},[i]),X=t=>{if(t.key==="Tab"){t.preventDefault();const l=t.target.selectionStart,j=t.target.selectionEnd,v=o.substring(0,l)+"    "+o.substring(j);N(v),setTimeout(()=>{t.target.selectionStart=t.target.selectionEnd=l+4},0)}(t.ctrlKey||t.metaKey)&&t.key==="Enter"&&A()},B=o.split(`
`).length,U=p||y;return n.jsxs("div",{className:"code-editor",children:[n.jsxs("div",{className:"editor-header",children:[n.jsxs("span",{className:"editor-header-title",children:[n.jsx("i",{className:"fa-brands fa-python"})," Python Editor",I&&n.jsx("span",{className:"editor-header-badge",children:"Turtle"})]}),n.jsx("div",{className:"editor-header-actions",children:a&&n.jsxs("button",{className:`editor-header-btn${w?" active":""}`,onClick:()=>_(!w),children:[n.jsx("i",{className:"fa-solid fa-lightbulb"})," ",e("editor.hint")]})})]}),n.jsxs("div",{className:"editor-body",children:[n.jsx("div",{className:"line-numbers",children:Array.from({length:B},(t,l)=>n.jsx("span",{children:l+1},l+1))}),n.jsx("textarea",{ref:S,className:"code-input",value:o,onChange:t=>N(t.target.value),onKeyDown:X,spellCheck:!1,disabled:s,placeholder:e("editor.placeholder")})]}),n.jsxs("div",{className:"editor-toolbar-bottom",children:[n.jsx("button",{className:"editor-btn run-btn",onClick:()=>r(A),disabled:s,children:s?n.jsxs(n.Fragment,{children:[n.jsx("div",{className:"loading-spinner-small"})," ",e(f==="loading"?"editor.loadingPython":"editor.running")]}):n.jsxs(n.Fragment,{children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," ",e("editor.run")]})}),n.jsxs("div",{className:"editor-toolbar-right",children:[n.jsx("button",{className:"editor-btn",onClick:q,disabled:s,children:e("editor.reset")}),U&&n.jsx("button",{className:"editor-btn",onClick:R,disabled:s,children:e("editor.clearOutput")})]})]}),w&&a&&n.jsxs("div",{className:"editor-hint",children:[n.jsx("strong",{children:e("editor.expectedOutput")})," ",n.jsx("code",{children:a})]}),m&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:[n.jsx("i",{className:"fa-solid fa-keyboard"})," ",e("editor.inputHeader")]}),n.jsxs("form",{className:"editor-input-form",onSubmit:K,children:[D.map((t,l)=>n.jsxs("div",{className:"editor-input-row",children:[n.jsx("label",{children:t}),n.jsx("input",{className:"editor-input-field",value:d[l]||"",onChange:j=>{const v=l;u(O=>{const M=[...O];return M[v]=j.target.value,M})},autoFocus:l===0})]},l)),n.jsxs("button",{type:"submit",className:"editor-btn run-btn",children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," ",e("editor.run")]})]})]}),!m&&(f==="done"||f==="error"||p||y)&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:[e("editor.result"),a&&T&&T.trim()===a.trim()&&n.jsx("span",{className:"output-correct",children:e("editor.correct")})]}),n.jsxs("div",{className:`editor-output-content${f==="error"?" has-error":""}`,children:[T&&n.jsx("pre",{className:"editor-stdout",children:T}),L&&n.jsx("div",{className:"editor-turtle-svg",dangerouslySetInnerHTML:{__html:L}}),y&&n.jsx("pre",{className:"editor-stderr",children:y}),!p&&!y&&f==="done"&&n.jsx("span",{className:"editor-no-output",children:e("editor.noOutput")})]})]})]})}function tn(){const{level:x,lessonId:a}=$(),{completedLessons:F,completeLesson:o,uncompleteLesson:N}=J(),{requireAuth:w}=E(),{t:_,lang:d,localizedField:u}=H(),[m,b]=h.useState(0),S=G[x],g=V[x]||[],r=g.find(i=>i.id===a),e=Y[a],C=F.has(a),f=g.findIndex(i=>i.id===a),p=f>0?g[f-1]:null,y=f<g.length-1?g[f+1]:null;if(!r||!S)return n.jsx("div",{className:"not-found-page",children:n.jsxs("div",{className:"not-found-content",children:[n.jsx("div",{className:"not-found-code",children:"404"}),n.jsx("h2",{className:"not-found-title",children:_("notFound.title")}),n.jsx(k,{to:`/${x}`,className:"btn btn-primary",children:_("lesson.backToLevel")})]})});const c=e?.sections||[{title:u(r,"title"),content:d==="en"?`In this lesson, you will learn about ${u(r,"description")}.`:`이 레슨에서는 ${r.description}에 대해 학습합니다.`,code:`# 예제 코드
print("Hello, Python!")`,expectedOutput:"Hello, Python!"}];return n.jsxs("div",{className:"lesson-page",children:[n.jsx("section",{className:"page-header",children:n.jsxs("div",{className:"container",children:[n.jsxs("div",{className:"breadcrumb",children:[n.jsx(k,{to:"/",children:d==="en"?"Home":"홈"}),n.jsx("span",{children:"/"}),n.jsxs(k,{to:`/${x}`,children:[u(S,"title")," ",_("level.course")]}),n.jsx("span",{children:"/"}),n.jsx("span",{children:u(r,"title")})]}),n.jsx("div",{className:"page-header-content",children:n.jsxs("div",{className:"page-header-title-row",children:[n.jsx("span",{className:"page-header-icon",children:n.jsx("i",{className:r.icon})}),n.jsxs("div",{children:[n.jsx("h1",{children:u(r,"title")}),n.jsx("p",{children:u(r,"description")}),n.jsxs("div",{className:"lesson-meta-bar",children:[n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clock"})," ",d==="en"?`~${r.estimatedTime}min`:`약 ${r.estimatedTime}분`]}),n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clipboard"})," ",r.topics?.length||0," ",d==="en"?"topics":"개 주제"]}),n.jsx("span",{children:Array.from({length:3},(i,s)=>n.jsx("i",{className:s<r.difficulty?"fa-solid fa-star":"fa-regular fa-star"},s))})]})]})]})})]})}),n.jsxs("div",{className:"lesson-layout container",children:[n.jsxs("aside",{className:"lesson-sidebar",children:[n.jsx("h3",{children:d==="en"?"Contents":"학습 목차"}),n.jsx("ul",{className:"lesson-toc",children:c.map((i,s)=>n.jsx("li",{children:n.jsxs("button",{className:`toc-item${m===s?" active":""}`,onClick:()=>b(s),children:[n.jsx("span",{className:"toc-number",children:s+1}),n.jsx("span",{className:"toc-title",children:i.title})]})},s))}),r.topics&&n.jsxs("div",{className:"lesson-topics-list",children:[n.jsx("h4",{children:d==="en"?"Topics":"학습 주제"}),r.topics.map((i,s)=>n.jsx("span",{className:"topic-tag",children:i},s))]})]}),n.jsxs("main",{className:"lesson-content",children:[n.jsxs("div",{className:"lesson-section",children:[n.jsx("h2",{children:c[m]?.title}),n.jsx("div",{className:"lesson-text",dangerouslySetInnerHTML:{__html:c[m]?.content?.replace(/\n/g,"<br/>")}}),c[m]?.code&&n.jsxs("div",{className:"lesson-practice",children:[n.jsx("h3",{children:_("lesson.tryCode")}),n.jsx(Z,{initialCode:c[m].code,expectedOutput:c[m].expectedOutput||"",lessonId:a},`${a}-${m}`)]}),c[m]?.tip&&n.jsxs("div",{className:"lesson-tip",children:[n.jsx("span",{className:"tip-icon",children:n.jsx("i",{className:"fa-solid fa-lightbulb"})}),n.jsxs("div",{children:[n.jsx("strong",{children:d==="en"?"Tip:":"팁:"})," ",c[m].tip]})]})]}),n.jsxs("div",{className:"lesson-nav",children:[n.jsx("div",{className:"lesson-nav-left",children:p&&n.jsxs(k,{to:`/${x}/${p.id}`,className:"lesson-nav-btn prev",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"15 18 9 12 15 6"})}),n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:_("lesson.prevLesson")}),n.jsx("span",{className:"nav-title",children:u(p,"title")})]})]})}),!C&&n.jsxs("button",{className:"btn btn-accent complete-btn",onClick:()=>w(()=>o(a)),children:[n.jsx("i",{className:"fa-solid fa-check"})," ",_("lesson.completeLesson")]}),C&&n.jsxs("button",{className:"btn btn-outline complete-toggle-btn",onClick:()=>w(()=>N(a)),children:[n.jsx("i",{className:"fa-solid fa-rotate-left"})," ",d==="en"?"Undo Complete":"완료 취소"]}),n.jsx("div",{className:"lesson-nav-right",children:y&&n.jsxs(k,{to:`/${x}/${y.id}`,className:"lesson-nav-btn next",children:[n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:_("lesson.nextLesson")}),n.jsx("span",{className:"nav-title",children:u(y,"title")})]}),n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"9 18 15 12 9 6"})})]})})]})]})]})]})}export{tn as default};
