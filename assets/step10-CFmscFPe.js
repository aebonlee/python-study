const t=[{name:"list",title:"리스트 기초",desc:"생성, append, 인덱싱, in 연산자",code:`# === 리스트 기초 ===
...
print("과목 수:", len(slist))      # 리스트 길이`},{name:"list1",title:"리스트 연산 모음",desc:"인덱싱, len(), in/not in",code:`# === 리스트 연산 모음 ===
# 리스트의 다양한 연산을 알아봅니다.
...
mylist.append(6)
mylist.append(3)
print("append 결과:", mylist)  # [1, 2, 6, 3]`},{name:"list2",title:"리스트 메서드",desc:"append, insert, remove, pop",code:`# === 리스트 메서드 ===
# 리스트의 주요 메서드를 알아봅니다.
...
# 문자열에서도 in 사용 가능
print("'e' in 'Hello':", 'e' in 'Hello')  # True`},{name:"list3",title:"리스트 슬라이싱·집계",desc:"+, *, min/max/sum",code:`# === 리스트 슬라이싱·집계 ===
...
print(f"pop(0) → '{item}', 남은 리스트:", myList)`},{name:"list4",title:"리스트 정렬",desc:"sort(), sorted(), reverse",code:`# === 리스트 정렬 ===
# 리스트 연산(+, *), 슬라이싱, 집계 함수
...
print("min(['dog','cat','tiger']):", min(["dog", "cat", "tiger"]))`},{name:"dict1",title:"딕셔너리 기초",desc:"키로 값 조회·수정",code:`# === 리스트 정렬 ===
...
print("내림차순:", new_list)`},{name:"dict2",title:"딕셔너리 생성·keys/values",desc:"keys(), values() 메서드",code:`# === 딕셔너리 기초 ===
...
# 값 수정
phone_book["강감찬"] = '9999'
print("수정 후:", phone_book["강감찬"])`},{name:"dict3",title:"딕셔너리 순회·삭제",desc:"sorted(), pop(), clear()",code:`# === 딕셔너리 생성·keys/values ===
...
# values() - 모든 값 반환
print("값 목록:", phone_book.values())`},{name:"eng_dict",title:"영어 사전 검색",desc:"딕셔너리로 영한 사전 구현",code:`# === 영어 사전 검색 ===
...
for word in words_to_search:
    if word in english_dict:
        ...
        print(f"{word} → 사전에 없는 단어입니다.")`},{name:"schedule",title:"일정 관리",desc:"날짜-일정 딕셔너리 관리",code:`# === 일정 관리 프로그램 ===
# 딕셔너리로 날짜별 일정을 관리합니다.
...
print("\\n전체 일정:")
print(mydict)`},{name:"stocks",title:"재고 검색",desc:"물건 재고 딕셔너리 조회",code:`# === 재고 검색 프로그램 ===
...
for item in search_items:
    if item in items:
        ...
        print(f"{item}: 등록되지 않은 물건입니다.")`},{name:"stats",title:"statistics 모듈",desc:"mean, median, mode, stdev",code:`# === statistics 모듈 ===
...
print(f"표준편차={statistics.stdev(sample):.4f}")  # 표본 표준편차`},{name:"grades",title:"성적 처리",desc:"딕셔너리+리스트로 성적 관리",code:`# === 성적 처리 프로그램 ===
...
print(f"\\n★ 전체 1등: {top['이름']} (합계 {sum(top[sub] for sub in subjects)}점)")`},{name:"hangman",title:"행맨 게임",desc:"리스트로 글자 맞히기 게임",code:`# === 행맨 게임 ===
...
if turns <= 0:
    print(f"\\n사용자 패배! 정답은 '{word}'")`}];export{t as default};
