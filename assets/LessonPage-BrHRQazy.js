import{r as d,u as A,j as n,c as R,l as q,L as j,b as X}from"./index-DgPRoL5g.js";import{u as B}from"./useCodeRunner-CExXxl_1.js";const U={"hello-python":{sections:[{title:"print() 함수로 출력하기",content:`파이썬에서 가장 먼저 배우는 것은 화면에 텍스트를 출력하는 것입니다.
...
Epoch 10/10 - Loss: 0.1484 - Accuracy: 98.71%`,tip:"TensorFlow는 프로덕션 배포에, PyTorch는 연구/프로토타이핑에 많이 사용됩니다. 최근에는 두 프레임워크 모두 기능이 비슷해지고 있습니다."}]}},k="__TURTLE_SVG__";function V({initialCode:f="",expectedOutput:i="",lessonId:P=""}){const[s,_]=d.useState(f),[l,S]=d.useState(!1),[g,m]=d.useState([]),[r,x]=d.useState(!1),v=d.useRef(null),{incrementCodeRuns:h}=A(),{status:u,output:a,errorMsg:o,runCode:c,resetOutput:e}=B(),y=u==="loading"||u==="running",T=d.useMemo(()=>{const t=[];for(const p of s.split(`
`)){if(p.trim().startsWith("#"))continue;const b=[...p.matchAll(new RegExp(`(?<![a-zA-Z])input\\s*\\(\\s*(?:["']([^"']*?)["'])?\\s*\\)`,"g"))];for(const N of b)t.push(N[1]||"입력하세요:");const w=[...p.matchAll(/(?:textinput|numinput)\s*\(\s*["'][^"']*["']\s*,\s*["']([^"']*?)["']/g)];for(const N of w)t.push(N[1]||"입력하세요:")}return t},[s]),L=d.useMemo(()=>/import\s+turtle|from\s+turtle\s+import|turtle\.Turtle/.test(s),[s]),C=a&&a.includes(k),O=C?a.substring(0,a.indexOf(k)).trim():a,D=C?a.substring(a.indexOf(k)+k.length).trim():"",F=d.useCallback(()=>{x(!1);const t=T;if(t.length>0){e(),m(new Array(t.length).fill("")),x(!0);return}c(s),h()},[c,s,T,e,h]),M=d.useCallback(t=>{t.preventDefault(),x(!1),c(s,g),h()},[c,s,g,h]),J=d.useCallback(()=>{_(f),m([]),x(!1),e()},[f,e]),E=d.useCallback(()=>{e(),x(!1)},[e]),K=t=>{if(t.key==="Tab"){t.preventDefault();const p=t.target.selectionStart,b=t.target.selectionEnd,w=s.substring(0,p)+"    "+s.substring(b);_(w),setTimeout(()=>{t.target.selectionStart=t.target.selectionEnd=p+4},0)}(t.ctrlKey||t.metaKey)&&t.key==="Enter"&&F()},H=s.split(`
`).length,I=a||o;return n.jsxs("div",{className:"code-editor",children:[n.jsxs("div",{className:"editor-header",children:[n.jsxs("span",{className:"editor-header-title",children:[n.jsx("i",{className:"fa-brands fa-python"})," Python Editor",L&&n.jsx("span",{className:"editor-header-badge",children:"Turtle"})]}),n.jsx("div",{className:"editor-header-actions",children:i&&n.jsxs("button",{className:`editor-header-btn${l?" active":""}`,onClick:()=>S(!l),children:[n.jsx("i",{className:"fa-solid fa-lightbulb"})," 힌트"]})})]}),n.jsxs("div",{className:"editor-body",children:[n.jsx("div",{className:"line-numbers",children:Array.from({length:H},(t,p)=>n.jsx("span",{children:p+1},p+1))}),n.jsx("textarea",{ref:v,className:"code-input",value:s,onChange:t=>_(t.target.value),onKeyDown:K,spellCheck:!1,disabled:y,placeholder:"# 파이썬 코드를 입력하세요..."})]}),n.jsxs("div",{className:"editor-toolbar-bottom",children:[n.jsx("button",{className:"editor-btn run-btn",onClick:F,disabled:y,children:y?n.jsxs(n.Fragment,{children:[n.jsx("div",{className:"loading-spinner-small"})," ",u==="loading"?"Python 로딩 중...":"실행 중..."]}):n.jsxs(n.Fragment,{children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})}),n.jsxs("div",{className:"editor-toolbar-right",children:[n.jsx("button",{className:"editor-btn",onClick:J,disabled:y,children:"초기화"}),I&&n.jsx("button",{className:"editor-btn",onClick:E,disabled:y,children:"출력 지우기"})]})]}),l&&i&&n.jsxs("div",{className:"editor-hint",children:[n.jsx("strong",{children:"예상 출력:"})," ",n.jsx("code",{children:i})]}),r&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:[n.jsx("i",{className:"fa-solid fa-keyboard"})," 입력값 입력"]}),n.jsxs("form",{className:"editor-input-form",onSubmit:M,children:[T.map((t,p)=>n.jsxs("div",{className:"editor-input-row",children:[n.jsx("label",{children:t}),n.jsx("input",{className:"editor-input-field",value:g[p]||"",onChange:b=>{const w=p;m(N=>{const z=[...N];return z[w]=b.target.value,z})},autoFocus:p===0})]},p)),n.jsxs("button",{type:"submit",className:"editor-btn run-btn",children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("polygon",{points:"5 3 19 12 5 21 5 3"})})," 실행"]})]})]}),!r&&(u==="done"||u==="error"||a||o)&&n.jsxs("div",{className:"editor-output",children:[n.jsxs("div",{className:"editor-output-header",children:["실행 결과",i&&O&&O.trim()===i.trim()&&n.jsx("span",{className:"output-correct",children:"정답!"})]}),n.jsxs("div",{className:`editor-output-content${u==="error"?" has-error":""}`,children:[O&&n.jsx("pre",{className:"editor-stdout",children:O}),D&&n.jsx("div",{className:"editor-turtle-svg",dangerouslySetInnerHTML:{__html:D}}),o&&n.jsx("pre",{className:"editor-stderr",children:o}),!a&&!o&&u==="done"&&n.jsx("span",{className:"editor-no-output",children:"(출력 없음)"})]})]})]})}function W(){const{level:f,lessonId:i}=R(),{completedLessons:P,completeLesson:s,uncompleteLesson:_}=A(),[l,S]=d.useState(0),g=X[f],m=q[f]||[],r=m.find(c=>c.id===i),x=U[i],v=P.has(i),h=m.findIndex(c=>c.id===i),u=h>0?m[h-1]:null,a=h<m.length-1?m[h+1]:null;if(!r||!g)return n.jsx("div",{className:"not-found-page",children:n.jsxs("div",{className:"not-found-content",children:[n.jsx("div",{className:"not-found-code",children:"404"}),n.jsx("h2",{className:"not-found-title",children:"레슨을 찾을 수 없습니다"}),n.jsx(j,{to:`/${f}`,className:"btn btn-primary",children:"목록으로 돌아가기"})]})});const o=x?.sections||[{title:r.title,content:`이 레슨에서는 ${r.description}에 대해 학습합니다.`,code:`# 예제 코드
print("Hello, Python!")`,expectedOutput:"Hello, Python!"}];return n.jsxs("div",{className:"lesson-page",children:[n.jsx("section",{className:"page-header",children:n.jsxs("div",{className:"container",children:[n.jsxs("div",{className:"breadcrumb",children:[n.jsx(j,{to:"/",children:"홈"}),n.jsx("span",{children:"/"}),n.jsxs(j,{to:`/${f}`,children:[g.title," 과정"]}),n.jsx("span",{children:"/"}),n.jsx("span",{children:r.title})]}),n.jsx("div",{className:"page-header-content",children:n.jsxs("div",{className:"page-header-title-row",children:[n.jsx("span",{className:"page-header-icon",children:n.jsx("i",{className:r.icon})}),n.jsxs("div",{children:[n.jsx("h1",{children:r.title}),n.jsx("p",{children:r.description}),n.jsxs("div",{className:"lesson-meta-bar",children:[n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clock"})," 약 ",r.estimatedTime,"분"]}),n.jsxs("span",{children:[n.jsx("i",{className:"fa-solid fa-clipboard"})," ",r.topics?.length||0,"개 주제"]}),n.jsx("span",{children:Array.from({length:3},(c,e)=>n.jsx("i",{className:e<r.difficulty?"fa-solid fa-star":"fa-regular fa-star"},e))})]})]})]})})]})}),n.jsxs("div",{className:"lesson-layout container",children:[n.jsxs("aside",{className:"lesson-sidebar",children:[n.jsx("h3",{children:"학습 목차"}),n.jsx("ul",{className:"lesson-toc",children:o.map((c,e)=>n.jsx("li",{children:n.jsxs("button",{className:`toc-item${l===e?" active":""}`,onClick:()=>S(e),children:[n.jsx("span",{className:"toc-number",children:e+1}),n.jsx("span",{className:"toc-title",children:c.title})]})},e))}),r.topics&&n.jsxs("div",{className:"lesson-topics-list",children:[n.jsx("h4",{children:"학습 주제"}),r.topics.map((c,e)=>n.jsx("span",{className:"topic-tag",children:c},e))]})]}),n.jsxs("main",{className:"lesson-content",children:[n.jsxs("div",{className:"lesson-section",children:[n.jsx("h2",{children:o[l]?.title}),n.jsx("div",{className:"lesson-text",dangerouslySetInnerHTML:{__html:o[l]?.content?.replace(/\n/g,"<br/>")}}),o[l]?.code&&n.jsxs("div",{className:"lesson-practice",children:[n.jsx("h3",{children:"직접 실습해보세요"}),n.jsx(V,{initialCode:o[l].code,expectedOutput:o[l].expectedOutput||"",lessonId:i},`${i}-${l}`)]}),o[l]?.tip&&n.jsxs("div",{className:"lesson-tip",children:[n.jsx("span",{className:"tip-icon",children:n.jsx("i",{className:"fa-solid fa-lightbulb"})}),n.jsxs("div",{children:[n.jsx("strong",{children:"팁:"})," ",o[l].tip]})]})]}),n.jsxs("div",{className:"lesson-nav",children:[n.jsx("div",{className:"lesson-nav-left",children:u&&n.jsxs(j,{to:`/${f}/${u.id}`,className:"lesson-nav-btn prev",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"15 18 9 12 15 6"})}),n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"이전 레슨"}),n.jsx("span",{className:"nav-title",children:u.title})]})]})}),!v&&n.jsxs("button",{className:"btn btn-accent complete-btn",onClick:()=>s(i),children:[n.jsx("i",{className:"fa-solid fa-check"})," 학습 완료"]}),v&&n.jsxs("button",{className:"btn btn-outline complete-toggle-btn",onClick:()=>_(i),children:[n.jsx("i",{className:"fa-solid fa-rotate-left"})," 완료 취소"]}),n.jsx("div",{className:"lesson-nav-right",children:a&&n.jsxs(j,{to:`/${f}/${a.id}`,className:"lesson-nav-btn next",children:[n.jsxs("div",{children:[n.jsx("span",{className:"nav-label",children:"다음 레슨"}),n.jsx("span",{className:"nav-title",children:a.title})]}),n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("polyline",{points:"9 18 15 12 9 6"})})]})})]})]})]})]})}export{W as default};
