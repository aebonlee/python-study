...
#
# 중심: (0, 0)
# 거북이 초기 위치: (0, 0), 방향: 0° (오른쪽)`})})]}),e.jsx("h2",{children:"2. Turtle 기본 설정"}),e.jsxs("p",{children:["Turtle 프로그램을 시작하려면 먼저 ",e.jsx("code",{children:"turtle"})," 모듈을 가져오고(import), 화면과 거북이 객체를 설정해야 합니다."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"Turtle 기본 설정 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h2",{children:"4. 기본 도형 그리기"}),e.jsxs("p",{children:["도형을 그릴 때 핵심 원리는 ",e.jsx("strong",{children:"외각의 합 = 360°"}),"입니다. 정n각형을 그리려면 각 꼭짓점에서 ",e.jsx("strong",{children:"360 / n"})," 도씩 회전하면 됩니다."]}),e.jsx("h3",{children:"직선 그리기"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"직선 그리기"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"사각형 그리기"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"사각형 그리기 (반복문 활용)"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"삼각형 그리기"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"정삼각형 그리기"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"원 그리기"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"원 그리기 (circle 명령)"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"다각형 그리기 (일반화)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"정다각형 일반화: 외각 = 360/n"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h2",{children:"5. 색상과 채우기"}),e.jsxs("p",{children:["Turtle에서 색상을 지정하는 방법은 두 가지입니다: (1) 색상 이름 문자열 (예: ",e.jsx("code",{children:'"red"'}),", ",e.jsx("code",{children:'"blue"'}),"), (2) RGB 튜플 (예: ",e.jsx("code",{children:"(1.0, 0, 0)"}),"). RGB 모드에서 기본 범위는 0.0~1.0이지만, ",e.jsx("code",{children:"colormode(255)"}),"로 설정하면 0~255 범위를 사용할 수 있습니다."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"색상 지정 방법"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"도형 채우기 (begin_fill / end_fill)"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"무지개 색상 활용"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
# 함수 호출 문법
# ═══════════════════════════════════════
# 함수이름(인자1, 인자2, ...)`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"가장 단순한 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 함수 정의 ────────────────────────
def greet():
    """인사를 출력하는 함수"""
    print("안녕하세요!")
    print("파이썬 함수를 배워봅시다!")
...
greet()    # 같은 함수를 여러 번 호출 가능`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`안녕하세요!
파이썬 함수를 배워봅시다!
안녕하세요!
파이썬 함수를 배워봅시다!`})})]}),e.jsx("h2",{children:"7. 매개변수(Parameter)와 인자(Argument)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"매개변수(Parameter)"}),"는 함수를 정의할 때 괄호 안에 적는 변수명이고,",e.jsx("strong",{children:"인자(Argument)"}),"는 함수를 호출할 때 실제로 전달하는 값입니다."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"매개변수가 있는 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`# name은 '매개변수(Parameter)'
...
greet_person("김영희")   # 안녕하세요, 김영희님!`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"여러 매개변수 사용"}),e.jsx("pre",{children:e.jsx("code",{children:`def add_numbers(a, b):
    """두 수를 더하여 결과를 출력하는 함수"""
    result = a + b
    print(f"{a} + {b} = {result}")

add_numbers(3, 5)      # 3 + 5 = 8
add_numbers(100, 200)  # 100 + 200 = 300`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"기본값 매개변수 (Default Parameter)"}),e.jsx("pre",{children:e.jsx("code",{children:`def greet_with_title(name, title="님"):
    """호칭을 지정할 수 있는 인사 함수"""
    print(f"안녕하세요, {name}{title}!")

greet_with_title("홍길동")          # 안녕하세요, 홍길동님!
greet_with_title("김교수", " 교수님")  # 안녕하세요, 김교수 교수님!`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"반환값(return)이 있는 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`def calculate_area(width, height):
...
# 반환값을 직접 활용
print(f"넓이: {calculate_area(10, 4)}")  # 넓이: 40`})})]}),e.jsx("h2",{children:"8. Turtle + 함수 결합"}),e.jsxs("p",{children:["이제 Turtle 명령어와 함수를 결합하여, 도형 그리기를 함수로 모듈화해 봅시다. 이것이 ",e.jsx("strong",{children:"추상화"}),"의 실제 적용입니다. 복잡한 그리기 과정을 함수 하나의 호출로 단순화할 수 있습니다."]}),e.jsx("h3",{children:"draw_square(size) 함수"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"사각형 그리기 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"draw_triangle(size) 함수"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"삼각형 그리기 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"draw_polygon(sides, size) 일반화 함수"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"다각형 일반화 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"draw_star(size) 별 그리기 함수"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"별 그리기 함수"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"함수 조합으로 집 그리기"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"함수를 조합하여 집 그리기"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h2",{children:"9. 반복과 함수의 결합"}),e.jsx("p",{children:"반복문(for) 안에서 함수를 호출하면, 다양하고 아름다운 패턴을 만들 수 있습니다. 위치와 방향을 바꿔가며 함수를 반복 호출하는 것이 핵심입니다."}),e.jsx("h3",{children:"나선(Spiral) 패턴"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"나선 패턴 그리기"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsx("h3",{children:"원형 배치 패턴"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"원형으로 사각형 배치하기"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
...
turtle.done()`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"꽃 모양 패턴"}),e.jsx("pre",{children:e.jsx("code",{children:`import turtle
