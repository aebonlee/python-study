const e=[{name:"if1",title:"합격/불합격 판단",desc:"60점 기준 if-else",code:`# === 합격/불합격 판단 프로그램 ===
...
if score >= 60:            # score가 60 이상이면
    ...
    print("불합격입니다.")  # 불합격 출력`},{name:"if2",title:"홀수/짝수 판별",desc:"% 연산자로 판별",code:`# === 홀수/짝수 판별 프로그램 ===
...
if num % 2 == 0:           # num을 2로 나눈 나머지가 0이면
    ...
    print("홀수입니다.")    # 홀수`},{name:"if3",title:"turtle로 양수/음수 표시",desc:"if 조건에 따라 turtle 이동",code:`# === turtle로 양수/음수 표시 ===
...
turtle.done()`},{name:"if4",title:"양수/0/음수 (elif)",desc:"elif 기본 패턴",code:`# === 양수/0/음수 판별 (elif) ===
...
if num > 0:                # 양수인 경우
    ...
    print("음수입니다.")`},{name:"if5",title:"양수/0/음수 (중첩 if)",desc:"중첩 if 구조",code:`# === 양수/0/음수 판별 (중첩 if) ===
...
if num >= 0:               # 0 이상인 경우
    ...
    print("음수입니다.")`},{name:"elif",title:"양수/0/음수 판별",desc:"if-elif-else 기본 예제",code:`# === 양수/0/음수 판별 (if-elif-else) ===
...
if num > 0:
    ...
    print("음수입니다.")`},{name:"nested",title:"중첩 if 예제",desc:"중첩 if로 부호 판별",code:`# === 중첩 if 예제 ===
...
if num >= 0:
    ...
    print("음수입니다.")`},{name:"coin",title:"동전 던지기",desc:"random으로 앞면/뒷면",code:`# === 동전 던지기 게임 ===
...
print("게임이 종료되었습니다.")`},{name:"coin2",title:"이미지 동전 던지기",desc:"turtle GIF로 시각적 동전",code:`# === 이미지 동전 던지기 ===
# [주의] turtle 모듈은 브라우저에서 실행할 수 없습니다.
# 코드를 다운로드하여 IDLE 또는 VS Code에서 실행하세요.
...
turtle.done()`},{name:"fgame",title:"페널티킥 수비 게임",desc:"랜덤 방향 vs 사용자 선택",code:`# === 페널티킥 수비 게임 ===
...
if computer_choice == user_choice:
    ...
    print("페널티킥이 성공하였습니다.")  # 다르면 골`},{name:"movie",title:"영화 관람 나이 제한",desc:"15세 이상 판별",code:`# === 영화 관람 나이 제한 ===
...
if age >= 15:
    ...
    print("본 영화를 보실 수 없습니다.")     # 15세 미만`},{name:"command",title:"시스템 명령어 처리",desc:"if-elif로 명령 분기",code:`# === 시스템 명령어 처리 ===
...
if command == "shutdown":
    ...
    print("알수 없는 명령어입니다.")`},{name:"sing",title:"종달새 노래 조건",desc:"시간·날씨 and 복합 조건",code:`# === 종달새 노래 조건 ===
...
if time >= 6 and time < 9 and sunny:
    ...
    print("종달새가 노래를 하지 않습니다.")`},{name:"leap",title:"윤년 판별",desc:"4, 100, 400 복합 논리 연산",code:`# === 윤년 판별 프로그램 ===
...
if (year % 4 == 0 and year % 100 != 0) or year % 400 == 0:
    ...
    print(year, "년은 윤년이 아닙니다.")`},{name:"for_teller",title:"미래 예언 프로그램",desc:"랜덤+if로 8가지 예언",code:`# === 미래 예언 프로그램 ===
...
if answers == 1:
    ...
    print("나중에 다시 물어 보세요.")`}];export{e as default};
