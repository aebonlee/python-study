...
┌─────────┐
│   끝    │
└─────────┘`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"순차 구조 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 순차 구조: 이름 입력 → 인사말 생성 → 출력 ──
...
# 출력
print(msg)`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`이름을 입력하세요: 홍길동
안녕하세요, 홍길동님!`})})]}),e.jsx("h3",{children:"(2) 선택 구조 (Selection)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"선택 구조"}),"는 ",e.jsx("strong",{children:"조건에 따라 실행 경로가 달라지는"})," 구조입니다. 순서도에서 마름모(판단) 기호를 사용하며, 조건의 참/거짓에 따라 서로 다른 처리를 수행합니다."]}),e.jsx("h4",{children:"단일 선택 (if)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"단일 선택 구조 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌─────────┐
│  시작   │
└────┬────┘
     ↓
╱‾‾‾‾‾‾‾‾‾‾‾‾╲
...
┌─────────┐
│   끝    │
└─────────┘`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"단일 선택 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`score = int(input("점수를 입력하세요: "))

if score >= 60:
    print("합격입니다!")

print("프로그램을 종료합니다.")`})})]}),e.jsx("h4",{children:"이중 선택 (if-else)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"이중 선택 구조 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
╱‾‾‾‾‾‾‾‾‾‾‾‾╲
...
┌──────────┐
│    끝    │
└──────────┘`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"이중 선택 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`score = int(input("점수를 입력하세요: "))

if score >= 60:
    print("합격입니다!")
else:
    print("불합격입니다.")`})})]}),e.jsx("h4",{children:"다중 선택 (if-elif-else)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"다중 선택 구조 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
╱‾‾‾‾‾‾‾‾‾‾‾‾╲
...
┌──────────┐
│    끝    │
└──────────┘`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"다중 선택 → 파이썬 코드: 성적 등급"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 성적 등급 판별 프로그램 ──
...
# 출력
print(f"점수: {score}, 등급: {grade}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`점수를 입력하세요: 85
점수: 85, 등급: B`})})]}),e.jsx("h3",{children:"(3) 반복 구조 (Iteration / Loop)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"반복 구조"}),"는 ",e.jsx("strong",{children:"조건이 참인 동안 특정 처리를 반복"}),"하는 구조입니다. 반복 구조에는 사전 검사 반복(while)과 횟수 반복(for) 두 가지가 있습니다."]}),e.jsx("h4",{children:"사전 검사 반복 (while)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"while 반복 구조 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
┌──────────┐
...
└────┬─────┘
     │
     └──────→ (판단으로 돌아감)`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"while 반복 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 1부터 5까지 출력 (while문) ──
...
print("반복 종료")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`반복 1번째
반복 2번째
반복 3번째
반복 4번째
반복 5번째
반복 종료`})})]}),e.jsx("h4",{children:"횟수 반복 (for)"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"for 반복 구조 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
┌──────────────────┐
...
╲____________╱
     │
     └──────→ (다음 i 값으로)`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"for 반복 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 1부터 5까지 출력 (for문) ──

for i in range(1, 6):    # i = 1, 2, 3, 4, 5
    print(f"반복 {i}번째")

print("반복 종료")`})})]}),e.jsx("h4",{children:"반복 구조 예시: 구구단"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"구구단 순서도"}),e.jsx("pre",{children:e.jsx("code",{children:`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
╱‾‾‾‾‾‾‾‾‾‾‾‾╲
...
│ i = i + 1│
└────┬─────┘
     └──────→ (판단으로)`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"구구단 → 파이썬 코드"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── 구구단 출력 ──
...
for i in range(1, 10):
    result = dan * i
    print(f"{dan} × {i} = {result}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`몇 단을 출력할까요? 7
...
[출력: sum]
  ↓
[끝]`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 두 수의 합"}),e.jsx("pre",{children:e.jsx("code",{children:`# ═══════════════════════════════════════
# 예제 1: 두 수의 합 (순차 구조)
# ═══════════════════════════════════════
...
# 출력
print(f"{a} + {b} = {total}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`첫 번째 정수: 15
두 번째 정수: 27
15 + 27 = 42`})})]}),e.jsx("h3",{children:"예제 2: 짝수/홀수 판별 (선택 구조)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"문제:"})," 정수를 입력받아 짝수인지 홀수인지 판별하라."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"순서도 (텍스트 표현)"}),e.jsx("pre",{children:e.jsx("code",{children:`[시작]
  ↓
[입력: num]
  ↓
<num % 2 == 0?>
  ...
  └─ No  → [출력: "홀수"]
  ↓
[끝]`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 짝수/홀수 판별"}),e.jsx("pre",{children:e.jsx("code",{children:`# ═══════════════════════════════════════
# 예제 2: 짝수/홀수 판별 (선택 구조)
# 핵심: 나머지 연산(%) 활용
# ═══════════════════════════════════════
...
if num % 2 == 0:
    ...
    print(f"{num}은(는) 홀수입니다.")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`정수를 입력하세요: 7
7은(는) 홀수입니다.`})})]}),e.jsx("h3",{children:"예제 3: 최대값 찾기 (선택 구조)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"문제:"})," 두 수를 입력받아 더 큰 수를 출력하라."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"순서도 (텍스트 표현)"}),e.jsx("pre",{children:e.jsx("code",{children:`[시작]
  ↓
[입력: a]
  ↓
[입력: b]
...
[출력: max_val]
  ↓
[끝]`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 최대값 찾기"}),e.jsx("pre",{children:e.jsx("code",{children:`# ═══════════════════════════════════════
...
# 출력
print(f"두 수 중 최대값: {max_val}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`첫 번째 수: 42
두 번째 수: 78
두 수 중 최대값: 78`})})]}),e.jsx("h3",{children:"예제 4: 1~N 합계 (반복 구조)"}),e.jsxs("p",{children:[e.jsx("strong",{children:"문제:"})," 정수 N을 입력받아 1부터 N까지의 합을 구하라."]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"순서도 (텍스트 표현)"}),e.jsx("pre",{children:e.jsx("code",{children:`[시작]
  ↓
[입력: N]
  ↓
[처리: total = 0, i = 1]  ← 초기화
...
<i <= N?>
  ...
  └─ No  → [출력: total]
              ↓
           [끝]`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 1~N 합계 (while 버전)"}),e.jsx("pre",{children:e.jsx("code",{children:`# ═══════════════════════════════════════
...
# 출력
print(f"1부터 {N}까지의 합: {total}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 1~N 합계 (for 버전)"}),e.jsx("pre",{children:e.jsx("code",{children:`# ── for문 버전 (더 간결한 파이썬 스타일) ──
...
print(f"1부터 {N}까지의 합: {total}")`})})]}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"실행 결과"}),e.jsx("pre",{children:e.jsx("code",{children:`N을 입력하세요: 100
1부터 100까지의 합: 5050`})})]}),e.jsx("h2",{children:"7. 알고리즘 설계 연습"}),e.jsx("p",{children:"체계적인 문제 해결 과정은 다음과 같습니다. 이 과정을 반복적으로 연습하면 어떤 문제든 논리적으로 접근할 수 있는 능력이 길러집니다."}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"체계적 문제 해결 과정"}),e.jsx("pre",{children:e.jsx("code",{children:`1단계: 문제 분석   → 무엇을 구해야 하는지 파악
2단계: PDC 작성    → Input / Process / Output 정리
3단계: 순서도 작성  → 논리 흐름을 시각화
4단계: 코드 작성   → 프로그래밍 언어로 구현
5단계: 테스트      → 다양한 입력으로 검증`})})]}),e.jsx("h3",{children:"종합 예제: 세 수 중 최대값 찾기"}),e.jsxs("p",{children:[e.jsx("strong",{children:"문제:"})," 세 개의 정수를 입력받아 가장 큰 수를 출력하라."]}),e.jsx("p",{children:e.jsx("strong",{children:"1단계: 문제 분석"})}),e.jsx("p",{children:"세 수를 비교하여 가장 큰 수를 찾아야 합니다. 두 수씩 비교하는 방법을 사용합니다."}),e.jsx("p",{children:e.jsx("strong",{children:"2단계: PDC 작성"})}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"PDC - 세 수 중 최대값"}),e.jsx("pre",{children:e.jsx("code",{children:`┌─────────────────────────────────────────────────────────────┐
...
│              │ if c > max_val:       │                      │
│              │   max_val = c         │                      │
└──────────────┴───────────────────────┴──────────────────────┘`})})]}),e.jsx("p",{children:e.jsx("strong",{children:"3단계: 순서도"})}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"순서도 - 세 수 중 최대값"}),e.jsx("pre",{children:e.jsx("code",{children:`[시작]
  ↓
[입력: a, b, c]
  ↓
...
[출력: max_val]
  ↓
[끝]`})})]}),e.jsx("p",{children:e.jsx("strong",{children:"4단계: 파이썬 코드"})}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파이썬 코드: 세 수 중 최대값"}),e.jsx("pre",{children:e.jsx("code",{children:`# ═══════════════════════════════════════
...
# ── Output ──
print(f"입력한 수: {a}, {b}, {c}")
print(f"최대값: {max_val}")`})})]}),e.jsx("p",{children:e.jsx("strong",{children:"5단계: 테스트"})}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"다양한 테스트 케이스"}),e.jsx("pre",{children:e.jsx("code",{children:`# 테스트 1: 첫 번째가 최대
첫 번째 수: 30
두 번째 수: 10
세 번째 수: 20
입력한 수: 30, 10, 20
