...
print(min, "분", remainder, "초")  # 16분 40초`
  },
  {
    name: 'comp',
    title: '복합 대입 연산자',
...
print(math.isclose(3.141590003, 3.141590002))   # True (차이가 매우 작음)`
  },
  {
    name: 'string',
    title: '문자열 연산 및 메서드',
...
print(text.split())       # 공백 기준으로 분할 → 리스트`
  },
  {
    name: 'slice',
    title: '문자열 슬라이싱',
...
s = "문자열"  # 정답
print("Q: 프로그래밍 언어에서 텍스트를 무엇이라고 부르는가?", s, "→", s == "문자열")`
  },
];
