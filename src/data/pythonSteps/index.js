...
export const stepMeta = [
  ...
  { step: 5, icon: 'fa-solid fa-palette', title: 'Turtle 그래픽 (기초)', titleEn: 'Turtle Graphics (Basic)' },
  { step: 6, icon: 'fa-solid fa-gamepad', title: 'Turtle 그래픽 (심화)', titleEn: 'Turtle Graphics (Advanced)' },
