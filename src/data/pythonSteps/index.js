...
export const stepMeta = [
  ...
  { step: 5, icon: 'fa-solid fa-palette', title: 'Turtle 그래픽', titleEn: 'Turtle Graphics' },
  { step: 6, icon: 'fa-solid fa-code-branch', title: 'IF 조건문', titleEn: 'Conditionals' },
  { step: 7, icon: 'fa-solid fa-repeat', title: '반복문 (While / For)', titleEn: 'Loops' },
  { step: 8, icon: 'fa-solid fa-gears', title: '함수와 매개변수', titleEn: 'Functions' },
  { step: 9, icon: 'fa-solid fa-shield-halved', title: '예외처리와 파일 I/O', titleEn: 'Exceptions & File I/O' },
  { step: 10, icon: 'fa-solid fa-table-cells', title: '리스트와 딕셔너리', titleEn: 'Lists & Dictionaries' },
