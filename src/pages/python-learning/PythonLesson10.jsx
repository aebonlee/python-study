      ...
      <div className="container">
        <div className="lesson-body">
          ...
          <div className="code-block">
            <div className="code-header">오류 메시지 해석</div>
...
print("안녕하세요")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">주요 예외 발생 예시</div>
...
# AttributeError: 'int' object has no attribute 'append'`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">예외 계층 구조 (주요 부분)</div>
...
# 단, KeyboardInterrupt, SystemExit 등은 잡히지 않음`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">논리 오류 예시</div>
...
print(total)  # 55`}</code></pre>
          ...
          <h3>5.1 문법</h3>
          <div className="code-block">
            <div className="code-header">try-except 기본 문법</div>
            <pre><code>{`try:
    # 오류가 발생할 수 있는 코드
    위험한_코드
except:
    ...
    오류_처리_코드`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">try-except 기본 예제</div>
...
try:
    ...
    print("잘못된 접근입니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">특정 예외 처리</div>
            <pre><code>{`try:
    a = int(input("분자: "))
    b = int(input("분모: "))
    result = a / b
    ...
    print("오류: 0으로 나눌 수 없습니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">여러 예외를 하나의 except로</div>
            <pre><code>{`try:
    num = int(input("숫자: "))
    result = 100 / num
    print(f"결과: {result}")
    ...
    print("올바른 숫자(0 제외)를 입력해주세요.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">as e로 오류 메시지 활용</div>
            <pre><code>{`try:
    num = int(input("숫자를 입력하세요: "))
    result = 100 / num
    ...
    print(f"예상치 못한 오류: {type(e).__name__}: {e}")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">try-except-else-finally 구조</div>
            <pre><code>{`try:
    # 오류가 발생할 수 있는 코드
    위험한_코드
    ...
    자원_정리`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">try-except-else-finally 실전 예제</div>
...
# 작업 완료 (항상 실행)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">안전한 정수 입력 함수</div>
...
print(f"입력한 점수: {score}")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">안전한 나눗셈</div>
...
print(safe_divide("a", 3))   # 경고 메시지 + None`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">메뉴 선택 입력 검증</div>
    ...
    while True:
        try:
          ...
          <div className="code-block">
            <div className="code-header">파일 열기 예외처리</div>
...
if content is not None:
    ...
    print("파일을 읽지 못했습니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">raise 사용 예시</div>
...
# 오류: 나이는 정수여야 합니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">print 디버깅 예시</div>
...
# 디버깅이 완료되면 [DEBUG] print문을 제거합니다.`}</code></pre>
          ...
          <h3>예제 1: 안전한 계산기</h3>
          <div className="code-block">
            <div className="code-header">예외처리가 포함된 사칙연산 계산기</div>
...
calculator()`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">범위 검증 + 형변환 검증이 포함된 성적 프로그램</div>
...
try:
    ...
    print("\\n입력이 취소되었습니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">숫자 맞추기 게임</div>
...
number_guessing_game()`}</code></pre>
          ...
          <div className="lesson-nav">
            <Link to="/python-learning/09" className="lesson-nav-btn prev">← 09: 함수</Link>
            <Link to="/python-learning/11" className="lesson-nav-btn next">11: 리스트 →</Link>
          </div>
        </div>
      </div>
    </section>
