      ...
      <div className="container">
        <div className="lesson-body">
          ...
          <div className="code-block">
            <div className="code-header">IPO 구조의 기본 예제</div>
            <pre><code>{`# ═══════════════════════════════════════
# 가장 기본적인 IPO 프로그램
# ═══════════════════════════════════════
...
당신은 2006년에 태어났습니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC - 사각형 넓이</div>
            <pre><code>{`┌─────────────────────────────────────────────────┐
...
└────────────┴─────────────────┴──────────────────┘`}</code></pre>
          ...
          <h3>PDC 예시 2: 원의 넓이와 둘레 계산</h3>
          <div className="code-block">
            <div className="code-header">PDC - 원의 넓이와 둘레</div>
            <pre><code>{`┌──────────────────────────────────────────────────────┐
│            Problem Definition Chart                  │
│            원의 넓이와 둘레 계산                        │
├────────────┬───────────────────┬─────────────────────┤
...
└────────────┴───────────────────┴─────────────────────┘`}</code></pre>
          ...
          <h3>PDC 예시 3: BMI 계산</h3>
          <div className="code-block">
            <div className="code-header">PDC - BMI(체질량지수) 계산</div>
            <pre><code>{`┌──────────────────────────────────────────────────────┐
│            Problem Definition Chart                  │
│            BMI(체질량지수) 계산                        │
├──────────────┬──────────────────┬────────────────────┤
...
└──────────────┴──────────────────┴────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC → 파이썬 코드: 사각형 넓이</div>
            <pre><code>{`# ═══════════════════════════════════════
# PDC:
...
사각형의 넓이: 15.0`}</code></pre>
          ...
          <h3>예제 2: 원의 넓이와 둘레 계산</h3>
          <div className="code-block">
            <div className="code-header">PDC → 파이썬 코드: 원의 넓이와 둘레</div>
            <pre><code>{`# ═══════════════════════════════════════
# PDC:
# Input   : 반지름(r)
# Process : area = π × r × r
...
└────────────┴───────────────────┴─────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC → 파이썬 코드: 삼각형 넓이</div>
            <pre><code>{`# ═══════════════════════════════════════
# PDC:
...
삼각형의 넓이: 30.0`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC - 온도 변환</div>
            <pre><code>{`┌──────────────────────────────────────────────────────────┐
│              Problem Definition Chart                    │
│              섭씨 → 화씨 변환                               │
├──────────────┬────────────────────┬──────────────────────┤
...
└──────────────┴────────────────────┴──────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 온도 변환기</div>
            <pre><code>{`# ═══════════════════════════════════════
# 온도 변환기 (섭씨 → 화씨)
# 공식: F = C × 9/5 + 32
# ═══════════════════════════════════════
...
100.0°C = 212.0°F`}</code></pre>
          ...
          <h3>예제 5: 할인 가격 계산기</h3>
          <div className="code-block">
            <div className="code-header">PDC - 할인 가격 계산</div>
            <pre><code>{`┌──────────────────────────────────────────────────────────────┐
│                Problem Definition Chart                      │
│                할인 가격 계산                                   │
├──────────────┬──────────────────────┬────────────────────────┤
...
└──────────────┴──────────────────────┴────────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 할인 가격 계산기</div>
            <pre><code>{`# ═══════════════════════════════════════
# 할인 가격 계산기
# ═══════════════════════════════════════
...
==============================`}</code></pre>
          ...
          <h3>예제 6: 환율 계산기</h3>
          <div className="code-block">
            <div className="code-header">PDC - 환율 계산</div>
            <pre><code>{`┌──────────────────────────────────────────────────────────────┐
│                Problem Definition Chart                      │
│                환율 계산기 (원화 → 달러)                        │
├──────────────┬──────────────────────┬────────────────────────┤
...
└──────────────┴──────────────────────┴────────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 환율 계산기</div>
            <pre><code>{`# ═══════════════════════════════════════
# 환율 계산기 (원화 → 달러)
# ═══════════════════════════════════════
...
달러: $1,000.00`}</code></pre>
          ...
          <h3>예제 7: 시간 변환기 (초 → 시:분:초)</h3>
          <div className="code-block">
            <div className="code-header">PDC - 시간 변환</div>
            <pre><code>{`┌──────────────────────────────────────────────────────────────┐
│                Problem Definition Chart                      │
│                초 → 시:분:초 변환                               │
├──────────────┬──────────────────────┬────────────────────────┤
...
└──────────────┴──────────────────────┴────────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 시간 변환기</div>
            <pre><code>{`# ═══════════════════════════════════════
# 시간 변환기 (초 → 시:분:초)
...
3725초 = 1시간 2분 5초`}</code></pre>
          ...
          <h3>예제 8: 평균 계산기 (3과목)</h3>
          <div className="code-block">
            <div className="code-header">PDC - 3과목 평균 계산</div>
            <pre><code>{`┌──────────────────────────────────────────────────────────────┐
│                Problem Definition Chart                      │
│                3과목 성적 평균 계산                              │
├──────────────┬──────────────────────┬────────────────────────┤
...
└──────────────┴──────────────────────┴────────────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 3과목 평균 계산기</div>
            <pre><code>{`# ═══════════════════════════════════════
# 3과목 성적 평균 계산기
# ═══════════════════════════════════════
...
평균: 91.7점`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">프로그램 개발 과정</div>
            <pre><code>{`문제 이해
   ↓
PDC 작성 (입력/처리/출력 정의)
   ↓
...
테스트 및 디버깅 (오류 수정)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC 표현</div>
            <pre><code>{`Input   : width, height
Process : area = width × height
Output  : area`}</code></pre>
          </div>
          <div className="code-block">
            <div className="code-header">의사코드 표현</div>
            <pre><code>{`BEGIN
    READ width
    READ height
    area = width × height
...
END`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드</div>
...
print(f"사각형의 넓이: {area}")`}</code></pre>
          ...
          <div className="lesson-nav">
            <Link to="/python-learning/03" className="lesson-nav-btn prev">← 03: Data Type</Link>
            <Link to="/python-learning/05" className="lesson-nav-btn next">05: Turtle →</Link>
          </div>
        </div>
      </div>
    </section>
