      ...
      <div className="container">
        <div className="lesson-body">
          ...
          <div className="code-block">
            <div className="code-header">불리언 값 확인</div>
...
print(10 != 10) # False`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">순서도와 조건문의 대응</div>
...
if score >= 60:      # ◇ 조건 판단
    ...
    print("불합격")  # No 경로`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">if문 문법</div>
            <pre><code>{`if 조건식:
    실행할 코드1
    실행할 코드2
    ...
...
# 조건식이 False이면 → 들여쓰기된 코드 건너뜀`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">들여쓰기 오류 예시</div>
...
if age >= 18:
    print("성인입니다.")
      print("투표 가능합니다.")  # 들여쓰기 깊이가 다름!`}</code></pre>
          ...
          <h3>2-5. if문 예제</h3>
          <div className="code-block">
            <div className="code-header">기본 if문 예제 1 - 성인 여부</div>
            <pre><code>{`age = 20
...
print("프로그램 종료")  # if 블록 밖 → 항상 실행됨`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">기본 if문 예제 2 - 양수 판별</div>
...
if number == 0:
    print("0을 입력했습니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">기본 if문 예제 3 - 블록 범위 이해</div>
...
# → if 블록의 범위는 들여쓰기로 결정됩니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">if-else문 문법</div>
            <pre><code>{`if 조건식:
    조건이 True일 때 실행할 코드
else:
    조건이 False일 때 실행할 코드`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">합격/불합격 판정</div>
...
# 다음 단계로 진행합니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">짝수/홀수 판별</div>
...
# 나머지가 0이면 짝수, 아니면 홀수`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">양수/음수 판별</div>
...
if num >= 0:
    ...
    print(f"{num}은(는) 음수입니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">if-elif-else문 문법</div>
            <pre><code>{`if 조건식1:
    조건식1이 True일 때 실행
elif 조건식2:
    ...
    위의 모든 조건이 False일 때 실행 (선택사항)`}</code></pre>
          ...
          <h3>4-3. 성적 등급 판별</h3>
          <div className="code-block">
            <div className="code-header">성적 등급 판별 (A/B/C/D/F)</div>
...
# 점수: 85점, 등급: B`}</code></pre>
          ...
          <h3>4-4. 요금 등급 계산</h3>
          <div className="code-block">
            <div className="code-header">나이에 따른 요금 등급</div>
...
if age < 0:
    ...
    print("경로 우대: 무료입니다.") # 65세 이상`}</code></pre>
          ...
          <h3>4-5. 계절 판별</h3>
          <div className="code-block">
            <div className="code-header">월(month)로 계절 판별</div>
...
# 7월은 여름입니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">= (대입) vs == (비교)</div>
...
# if x == 10:  ← 올바른 코드`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">문자열 비교 예제</div>
            <pre><code>{`# 문자열 동등 비교
...
print(ord("가")) # 44032`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">다양한 비교 연산자 활용</div>
            <pre><code>{`a = 10
b = 20
c = 10
...
print(0 <= x <= 100)   # True (0 <= 15 <= 100)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">단락 평가 예시</div>
...
if 0 <= score <= 100:
    print("유효한 점수입니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">복합 조건 예제</div>
...
# and가 or보다 우선순위가 높으므로 괄호가 중요합니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">멤버십 연산자 - 문자열에서 사용</div>
...
if "@" in email:
    ...
    print("이메일에 @가 포함되어야 합니다.")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">멤버십 연산자 - 리스트에서 사용</div>
...
if color in ["빨강", "노랑", "초록"]:
    ...
    print("잘못된 입력입니다.")`}</code></pre>
          ...
          <h3>8-2. 영화 요금 계산</h3>
          <div className="code-block">
            <div className="code-header">중첩 조건문 - 영화 요금 계산</div>
            <pre><code>{`# 영화 요금:
# - 어린이(12세 이하): 5,000원
...
if age <= 12:
    ...
    if is_member:               # ← 중첩 조건문
        ...
        print(f"성인 일반 요금: {price:,}원")`}</code></pre>
          ...
          <h3>8-3. 로그인 시스템</h3>
          <div className="code-block">
            <div className="code-header">중첩 조건문 - 로그인 시스템</div>
...
# 로그인 성공! 환영합니다.`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">조건 표현식 문법</div>
...
└──────────────┴─────────────────┴─────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">가위바위보 게임 코드</div>
...
└──────────────┴─────────────────┴─────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">윤년 판별기 코드</div>
...
└──────────────┴─────────────────┴─────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">택시 요금 계산기 코드</div>
...
└──────────────┴─────────────────┴─────────────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">BMI 판정 프로그램 코드</div>
            <pre><code>{`# 입력
...
# ==============================`}</code></pre>
          ...
          <div className="lesson-nav">
            <Link to="/python-learning/06" className="lesson-nav-btn prev">← 06: 순서도</Link>
            <Link to="/python-learning/08" className="lesson-nav-btn next">08: 반복문 →</Link>
          </div>
        </div>
      </div>
    </section>
