      ...
      <div className="container">
        <div className="lesson-body">
          ...
          <div className="code-block">
            <div className="code-header">알고리즘 예시 1: 라면 끓이기</div>
...
6단계: 완성!`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">알고리즘 예시 2: 도서관에서 책 찾기</div>
...
5단계: 책이 있으면 → 대출한다
       책이 없으면 → 예약을 신청한다`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">순서도 기호 요약 (텍스트 표현)</div>
            <pre><code>{`┌─────────┐
...
└─────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">순차 구조 순서도 (텍스트 표현)</div>
            <pre><code>{`┌─────────┐
│  시작   │
└────┬────┘
     ↓
...
└─────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">순차 구조 → 파이썬 코드</div>
...
안녕하세요, 홍길동님!`}</code></pre>
          ...
          <h4>단일 선택 (if)</h4>
          <div className="code-block">
            <div className="code-header">단일 선택 구조 순서도</div>
            <pre><code>{`┌─────────┐
│  시작   │
└────┬────┘
     ↓
...
└─────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">단일 선택 → 파이썬 코드</div>
...
print("프로그램을 종료합니다.")`}</code></pre>
          ...
          <h4>이중 선택 (if-else)</h4>
          <div className="code-block">
            <div className="code-header">이중 선택 구조 순서도</div>
            <pre><code>{`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
...
└──────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">이중 선택 → 파이썬 코드</div>
            <pre><code>{`score = int(input("점수를 입력하세요: "))
...
if score >= 60:
    ...
    print("불합격입니다.")`}</code></pre>
          ...
          <h4>다중 선택 (if-elif-else)</h4>
          <div className="code-block">
            <div className="code-header">다중 선택 구조 순서도</div>
            <pre><code>{`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
...
└──────────┘`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">다중 선택 → 파이썬 코드: 성적 등급</div>
...
점수: 85, 등급: B`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">while 반복 구조 순서도</div>
            <pre><code>{`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
...
└────┬─────┘
     ...
     └──────→ (판단으로 돌아감)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">while 반복 → 파이썬 코드</div>
...
반복 종료`}</code></pre>
          ...
          <h4>횟수 반복 (for)</h4>
          <div className="code-block">
            <div className="code-header">for 반복 구조 순서도</div>
            <pre><code>{`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
...
╲____________╱
     ...
     └──────→ (다음 i 값으로)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">for 반복 → 파이썬 코드</div>
...
print("반복 종료")`}</code></pre>
          ...
          <h4>반복 구조 예시: 구구단</h4>
          <div className="code-block">
            <div className="code-header">구구단 순서도</div>
            <pre><code>{`┌──────────┐
│   시작   │
└────┬─────┘
     ↓
...
└────┬─────┘
     └──────→ (판단으로)`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">구구단 → 파이썬 코드</div>
            <pre><code>{`# ── 구구단 출력 ──
...
7 × 9 = 63`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">순서도 (텍스트 표현)</div>
            <pre><code>{`[시작]
  ↓
[입력: a]
  ↓
...
[끝]`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 두 수의 합</div>
            <pre><code>{`# ═══════════════════════════════════════
# 예제 1: 두 수의 합 (순차 구조)
# ═══════════════════════════════════════
...
[끝]`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 짝수/홀수 판별</div>
            <pre><code>{`# ═══════════════════════════════════════
# 예제 2: 짝수/홀수 판별 (선택 구조)
# 핵심: 나머지 연산(%) 활용
# ═══════════════════════════════════════
...
[끝]`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 최대값 찾기</div>
            <pre><code>{`# ═══════════════════════════════════════
...
<i <= N?>
  ...
  └─ No  → [출력: total]
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 1~N 합계 (while 버전)</div>
            <pre><code>{`# ═══════════════════════════════════════
...
print(f"1부터 {N}까지의 합: {total}")`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">파이썬 코드: 1~N 합계 (for 버전)</div>
...
1부터 100까지의 합: 5050`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">체계적 문제 해결 과정</div>
...
5단계: 테스트      → 다양한 입력으로 검증`}</code></pre>
          ...
          <div className="code-block">
            <div className="code-header">PDC - 세 수 중 최대값</div>
            <pre><code>{`┌─────────────────────────────────────────────────────────────┐
...
└──────────────┴───────────────────────┴──────────────────────┘`}</code></pre>
          ...
          <p><strong>3단계: 순서도</strong></p>
          <div className="code-block">
            <div className="code-header">순서도 - 세 수 중 최대값</div>
            <pre><code>{`[시작]
  ↓
[입력: a, b, c]
  ↓
...
[끝]`}</code></pre>
          ...
          <p><strong>4단계: 파이썬 코드</strong></p>
          <div className="code-block">
            <div className="code-header">파이썬 코드: 세 수 중 최대값</div>
            <pre><code>{`# ═══════════════════════════════════════
...
print(f"최대값: {max_val}")`}</code></pre>
          ...
          <p><strong>5단계: 테스트</strong></p>
          <div className="code-block">
            <div className="code-header">다양한 테스트 케이스</div>
...
최대값: 30`}</code></pre>
          ...
          <div className="lesson-nav">
            <Link to="/python-learning/05" className="lesson-nav-btn prev">← 05: Turtle</Link>
            <Link to="/python-learning/07" className="lesson-nav-btn next">07: IF 조건문 →</Link>
          </div>
        </div>
      </div>
    </section>
